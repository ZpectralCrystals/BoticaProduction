...
const navigationItems = [
  ...
  { section: 'recepcion' as AppSection, to: '/panel/recepcion', label: 'Recepción', hint: 'Confirmar mercadería', icon: Truck },
  ...
  { section: 'inventario-var' as AppSection, to: '/panel/inventario-var', label: 'Inventario Avanzado', hint: 'Activos diversos', icon: Box },
...
const navigationGroups = [
  ...
  },
  {
    title: 'Comercial',
    items: navigationItems.filter((item) =>
      ['compras', 'recepcion', 'proveedores', 'deudores', 'reportes'].includes(item.section),
    ),
  },
  {
    title: 'Clinica',
    items: navigationItems.filter((item) =>
      ['pacientes', 'procedimientos', 'medicos'].includes(item.section),
    ),
  },
  {
...
const pageMeta: Record<string, { title: string; detail: string }> = {
  ...
  '/panel/recepcion': { title: 'Recepción', detail: 'Confirmar llegada física y actualizar stock.' },
  ...
  '/panel/inventario-var': { title: 'Inventario Avanzado', detail: 'Activos diversos: camillas, equipos, etc.' },
  '/panel/inventario-inicial': { title: 'Ingreso de inventario por primera vez', detail: 'Carga masiva inicial de productos existentes.' },
